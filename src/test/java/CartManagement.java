...
public class CartManagement {
    ...
    public void CheckoutBtn_EmptyCART() throws InterruptedException {
        ...
        driver.findElement(By.className("shopping_cart_link")).click();
        Thread.sleep(1000);
        softAssert.assertFalse(driver.findElement(By.id("checkout")).isEnabled(), "CHECKOUT button should be NOT clickable!");

        driver.findElement(By.id("checkout")).click();

        softAssert.assertEquals(driver.getCurrentUrl(), "https://www.saucedemo.com/cart.html","Checkout btn should be disabled");
